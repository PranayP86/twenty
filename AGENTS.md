...
`docs/FORK-STATUS.md` holds the full history of this fork, including the 2026-08-28 fresh-login and
resume hotfix and the 2026-08-23 and 2026-08-27 fork status entries. Read it before changing auth,
onboarding or workspace provisioning.

## Commands

`docs/COMMANDS.md` holds the full command set: development environment, per-package runs, single-test
invocations, Storybook, linting, type checking, formatting, builds, database management and GraphQL type
generation. Prefer the diff-against-main lint; the full-project lint is much slower.
